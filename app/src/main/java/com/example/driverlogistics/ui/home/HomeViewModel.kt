...
class HomeViewModel(
    ...
    private val resetDeliveriesUseCase: ResetDeliveriesUseCase
) : ViewModel() {
        ...
        viewModelScope.launch {
            ...
            runCatching {
                ...
                _uiState.update {
                    it.copy(
                        isLoading = false,
                        errorMessage = "No se pudieron reestablecer los estados"
                    )
                }
            }
        }
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(HomeViewModel::class.java)) {
            ...
            return HomeViewModel(
                observeDeliveriesUseCase = observeDeliveriesUseCase,
                resetDeliveriesUseCase = resetDeliveriesUseCase
            ) as T
        }
